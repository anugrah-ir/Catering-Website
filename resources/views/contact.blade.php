    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6 text-center">
                <h2 style="color: #070952; font-size: 40px; font-weight: Bold"">Lokasi Kami</h2>
                <iframe 
                ...
                <p style="color: #070952; margin-top: 20px; font-size: 22px;">Jalan Locari No.90 RT03 RW01 Sekarpuro<br>Kecamatan Pakis Kabupaten Malang 65154</p>
            </div>
            <div class="col-md-6 text-center d-flex flex-column align-items-center justify-content-center">
                ...
                <h1 style="color: #070952; margin-top: 20px;">Ny. Ayu Catering</h1>
                <p style="color: #070952; font-size: 20px;">+62 821-9823-7561</p>
                <p style="color: #070952; font-size: 20px;">Professional Service</p>
